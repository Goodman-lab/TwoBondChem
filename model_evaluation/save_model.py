...
ele_steps=pd.read_csv('cyclo_data_v2_13012024.csv')
...
ele_steps=pd.read_csv('diels_alder_data_v7_19052024.csv')
...
ele_steps=pd.read_csv('fav_RGD1_13012024_v2.csv')
...
ele_steps=pd.read_csv('green_04012024.csv')
