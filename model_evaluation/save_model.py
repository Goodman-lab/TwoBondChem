...
ele_steps=pd.read_csv('./dataset/cyclo_data_v2_16072024.csv').head(100)
...
ele_steps=pd.read_csv('./dataset/diels_alder_data_v7_19052024.csv').head(100)
...
ele_steps=pd.read_csv('./dataset/fav_RGD1_13012024_v2.csv').head(300)
...
ele_steps=pd.read_csv('./dataset/green_04012024.csv').head(100)
...
ele_steps=pd.read_csv('./dataset/first-year_data_all_27122023.csv')
