...
def descriptors_from_rxn(rxn):
    ...
    full_descriptor_react = descriptors_from_mol(react_mol)
    full_descriptor_prod = descriptors_from_mol(prod_mol)
...
def multi_path_descriptor_n_label(map_rxn_df, code, method='m3',bl_method='rdkit'):
    ...
    full_descriptor_react = descriptors_from_mol(reaction.react_H)
